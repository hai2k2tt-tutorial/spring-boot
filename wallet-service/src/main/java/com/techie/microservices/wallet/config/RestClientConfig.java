package com.techie.microservices.wallet.config;
...
public class RestClientConfig {
    ...
    public CustomerClient customerClient() {
        return createClient(customerServiceUrl, CustomerClient.class);
    }

    @Bean
    public ShopClient shopClient() {
        return createClient(shopServiceUrl, ShopClient.class);
    }
